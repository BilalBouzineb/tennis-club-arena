              ...
              <div className="space-y-4">
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <p className="text-sm text-gray-500">Receive updates about bookings, tournaments and club news</p>
                  </div>
                  <Switch 
                ...
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <p className="text-sm text-gray-500">Receive reminders before your scheduled court time</p>
                  </div>
                  <Switch 
                ...
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <p className="text-sm text-gray-500">Get notifications about tournament registrations and results</p>
                  </div>
                  <Switch 
